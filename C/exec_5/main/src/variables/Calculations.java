...
public class Calculations {
    ...
    public static void main(String[] args) {
        ...
        //double heightCm = Double.valueOf(args[0]);
       //double weight = Double.valueOf(args[1]);
       //double bmi = Double.valueOf(args[2]);

        double heightCm= Prompt.promptDouble("Podaj wzrost w cm: ");
        double weight= Prompt.promptDouble("Podaj mase w kg: ");
        double bmi= Prompt.promptDouble("Podaj docelowe BMI: ");
        ...
        Prompt.promptEnd("Wpisz tekst aby zakończyć: ");
    }
}