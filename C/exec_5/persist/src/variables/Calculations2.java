...
public class Calculations2 {
    ...
    public static void main(String[] args) {
        ...
        double height = Prompt.promptDouble("Podaj wzrost: ");
        double weight = Prompt.promptDouble("Podaj mase: ");
        double age = Prompt.promptDouble("Podaj wiek: ");
        double sexFactorM = 5;
        double sexFactorF = -161;
        double fitValue = Prompt.promptDouble("Podaj współczynnik aktywnosci fizycznej: ");
        
        String currentSex = Prompt.promptString("Podaj płeć, tzn. M lub F: ");
